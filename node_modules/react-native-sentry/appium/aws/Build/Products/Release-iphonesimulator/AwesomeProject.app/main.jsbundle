...
__d(function(e,t,n,r){"use strict";function a(e){function t(t,n){var r=e(t)||t;return n?n(r)||r:r}return t}function o(e,t){return e.replace(/^file\:\/\//,"app://").replace(t,"")}function i(e){var t=[];for(var n in e)({}).hasOwnProperty.call(e,n)&&t.push(encodeURIComponent(n)+"="+encodeURIComponent(e[n]));return t.join("&")}function l(t,n,r){n=n||{},t.setDataCallback(a(function(e){e=l._normalizeData(e,n.pathStrip),r&&r(e)})),n.nativeClientAvailable&&n.nativeClientAvailable===!1&&(t.setTransport(l._transport),l._restorePayload().then(function(e){n.onInitialize&&n.onInitialize(e),e&&t._sendProcessedPayload(e,function(e){e||l._clearPayload()})}).catch(function(){}),t.setShouldSendCallback(function(e,t){if(!(f in e))return!t||t.call(this,e);var n=e[f];return delete e[f],l._persistPayload(e).then(function(){return i(n,!0),o=!1,null}).catch(function(){}),!1}));var o=!1,i=ErrorUtils.getGlobalHandler&&ErrorUtils.getGlobalHandler()||ErrorUtils._globalHandler;ErrorUtils.setGlobalHandler(function(n,r){var a={timestamp:new Date/1e3},n=arguments[0],l=r&&!e.__DEV__;if(l){if(o)return void console.log("Encountered multiple fatals in a row. The latest:",n);o=!0,a[f]=n}t.captureException(n,a),u.Sentry._setInternalEventStored(function(){i(n,r)})})}var c=t(24),u=t(276),s=/^.*\/[^\.]+(\.app|CodePush)/,f="--rn-fatal--",d="--raven-js-global-error-payload--";l._persistPayload=function(e){var n=t(24).AsyncStorage;return n.setItem(d,JSON.stringify(e)).catch(function(){return null})},l._restorePayload=function(){var e=t(24).AsyncStorage,n=e.getItem(d).then(function(e){return JSON.parse(e)}).catch(function(){return null}),r=c.NativeModules.AsyncSQLiteDBStorage,a=c.NativeModules.AsyncRocksDBStorage,o=c.NativeModules.AsyncLocalStorage,i=a||r||o;return i.multiGet&&e.flushGetRequests(),n},l._clearPayload=function(){var e=t(24).AsyncStorage;return e.removeItem(d).catch(function(){return null})},l._transport=function(e){var t=new XMLHttpRequest;t.onreadystatechange=function(n){if(4===t.readyState)if(200===t.status)e.onSuccess&&e.onSuccess();else if(e.onError){var r=new Error("Sentry error code: "+t.status);r.request=t,e.onError(r)}},t.open("POST",e.url+"?"+i(e.auth)),t.setRequestHeader("Content-type","application/json"),t.setRequestHeader("Origin","react-native://"),t.send(JSON.stringify(e.data))},l._normalizeData=function(e,t){t||(t=s),e.culprit&&(e.culprit=o(e.culprit,t));var n=e.stacktrace||e.exception&&e.exception.values[0].stacktrace;return n&&n.frames.forEach(function(e){e.filename=o(e.filename,t)}),e},n.exports=l},285);
