...
let updateCredentialsForPlatform = exports.updateCredentialsForPlatform = (() => {
  var _ref2 = _asyncToGenerator(function* (platform, newCredentials, metadata) {
...
let removeCredentialsForPlatform = exports.removeCredentialsForPlatform = (() => {
  var _ref3 = _asyncToGenerator(function* (platform, metadata) {
...
let validateCredentialsForPlatform = exports.validateCredentialsForPlatform = (() => {
  var _ref4 = _asyncToGenerator(function* (platform, validationType, credentials, metadata) {
    const {
      isValid,
      error,
      errorCode,
...
let fetchAppleCertificates = exports.fetchAppleCertificates = (() => {
  var _ref5 = _asyncToGenerator(function* (metadata) {
    const {
      err,
      success,
      error,
...
let ensureAppId = exports.ensureAppId = (() => {
  var _ref6 = _asyncToGenerator(function* (metadata) {
    const {
      err,
      success,
      errorCode,
