...
let _callMethodAsync = (() => {
  var _ref = _asyncToGenerator(function* (url, method, requestBody, requestOptions) {
    ...
    let response = yield (_request || _load_request()).default.promise(options);
...
let _downloadAsync = (() => {
  var _ref2 = _asyncToGenerator(function* (url, path, progressFunction, retryFunction) {
    ...
    return new Promise(function (resolve, reject) {
      try {
        (0, (_requestProgress || _load_requestProgress()).default)((0, (_request || _load_request()).default)(url, { timeout: TIMEOUT }, function (err) {
          if (err !== null) {
        ...
        }).pipe(_fs.default.createWriteStream(path)).on('finish', function () {
  ...
  return function _downloadAsync(_x5, _x6, _x7, _x8) {
...
var _requestProgress;

function _load_requestProgress() {
  return _requestProgress = _interopRequireDefault(require('request-progress'));
}
