...
exports.getExpoSdkStatus = exports.EXPO_SDK_NOT_IMPORTED = exports.EXPO_SDK_NOT_INSTALLED = exports.EXPO_SDK_INSTALLED_AND_IMPORTED = exports.validateWithNetworkAsync = exports.validateLowLatencyAsync = exports.FATAL = exports.WARNING = exports.NO_ISSUES = undefined;
...
let _validateAssetFieldsAsync = (() => {
  var _ref2 = _asyncToGenerator(function* (projectRoot, exp) {
    try {
  ...
  return function _validateAssetFieldsAsync(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
})();

let _validatePackageJsonAndExpJsonAsync = (() => {
  var _ref4 = _asyncToGenerator(function* (exp, pkg, projectRoot) {
    if (!exp || !pkg) {
    ...
    try {
      ...
      if (validationResult.errors && validationResult.errors.length > 0) {
        ...
        (_ProjectUtils || _load_ProjectUtils()).logWarning(projectRoot, 'expo', fullMessage, 'doctor-schema-validation');
        return WARNING;
      } else {
  ...
  return function _validatePackageJsonAndExpJsonAsync(_x5, _x6, _x7) {
...
let _validateNodeModulesAsync = (() => {
  ...
  return function _validateNodeModulesAsync(_x8) {
...
let validateLowLatencyAsync = exports.validateLowLatencyAsync = (() => {
  ...
  return function validateLowLatencyAsync(_x9) {
...
let validateWithNetworkAsync = exports.validateWithNetworkAsync = (() => {
  ...
  return function validateWithNetworkAsync(_x10) {
    return _ref7.apply(this, arguments);
  };
})();

let validateAsync = (() => {
  var _ref8 = _asyncToGenerator(function* (projectRoot, allowNetwork) {
    let { exp, pkg } = yield (_ProjectUtils || _load_ProjectUtils()).readConfigJsonAsync(projectRoot);
  ...
  return function validateAsync(_x11, _x12) {
...
let getExpoSdkStatus = exports.getExpoSdkStatus = (() => {
  ...
  return function getExpoSdkStatus(_x13) {
