...
exports.readConfigJsonAsync = exports.readExpRcAsync = exports.configFilenameAsync = exports.fileExistsAsync = undefined;
...
let readConfigJsonAsync = exports.readConfigJsonAsync = (() => {
  var _ref4 = _asyncToGenerator(function* (projectRoot) {
    ...
    const configName = yield configFilenameAsync(projectRoot);
    const configPath = _path.default.join(projectRoot, configName);
  ...
  return function readConfigJsonAsync(_x4) {
...
function logError(projectRoot, tag, message, id) {
  ...
  (_Analytics || _load_Analytics()).logEvent('Project Error', {
    projectRoot,
    tag,
