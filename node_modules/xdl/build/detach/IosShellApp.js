...
let configureStandaloneIOSInfoPlistAsync = (() => {
  var _ref2 = _asyncToGenerator(function* (configFilePath, manifest, privateConfig = null, bundleIdentifier = null) {
  ...
  return function configureStandaloneIOSInfoPlistAsync(_x3, _x4) {
...
let configureStandaloneIOSShellPlistAsync = (() => {
  var _ref3 = _asyncToGenerator(function* (configFilePath, manifest, manifestUrl) {
  ...
  return function configureStandaloneIOSShellPlistAsync(_x5, _x6, _x7) {
    return _ref3.apply(this, arguments);
  };
})();

let configurePropertyListsAsync = (() => {
  var _ref4 = _asyncToGenerator(function* (manifest, args, configFilePath) {
  ...
  return function configurePropertyListsAsync(_x8, _x9, _x10) {
...
let preloadManifestAndBundleAsync = (() => {
  ...
  return function preloadManifestAndBundleAsync(_x11, _x12, _x13) {
    return _ref5.apply(this, arguments);
  };
})();

let cleanPropertyListBackupsAsync = (() => {
  var _ref6 = _asyncToGenerator(function* (configFilePath, restoreOriginals) {
  ...
  return function cleanPropertyListBackupsAsync(_x14, _x15) {
...
let buildAsync = (() => {
  var _ref7 = _asyncToGenerator(function* (args, iOSRootPath, relativeBuildDestination) {
  ...
  return function buildAsync(_x16, _x17, _x18) {
...
let createIOSShellAppAsync = (() => {
  ...
  return function createIOSShellAppAsync(_x19) {
