...
function renderUnversionedReactDependency(options) {
  ...
  attributes.subspecs = ['Core', 'ART', 'DevSupport', 'RCTActionSheet', 'RCTAnimation', 'RCTCameraRoll', 'RCTGeolocation', 'RCTImage', 'RCTNetwork', 'RCTText', 'RCTVibration', 'RCTWebSocket'];
