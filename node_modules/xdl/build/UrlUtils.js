...
let constructAssetsUrlAsync = exports.constructAssetsUrlAsync = (() => {
  ...
  return function constructAssetsUrlAsync(_x14, _x15, _x16) {
    return _ref5.apply(this, arguments);
  };
})();

let constructDebuggerHostAsync = exports.constructDebuggerHostAsync = (() => {
  var _ref6 = _asyncToGenerator(function* (projectRoot, requestHostname) {
    return constructUrlAsync(projectRoot, {
      urlType: 'no-protocol'
    }, true, requestHostname);
  });

  return function constructDebuggerHostAsync(_x17, _x18) {
    return _ref6.apply(this, arguments);
  };
})();

let constructBundleQueryParamsAsync = exports.constructBundleQueryParamsAsync = (() => {
  var _ref7 = _asyncToGenerator(function* (projectRoot, opts) {
  ...
  return function constructBundleQueryParamsAsync(_x19, _x20) {
    return _ref7.apply(this, arguments);
  };
})();

let constructUrlAsync = exports.constructUrlAsync = (() => {
  var _ref8 = _asyncToGenerator(function* (projectRoot, opts, isPackager, requestHostname) {
    if (opts) {
  ...
  return function constructUrlAsync(_x21, _x22, _x23, _x24) {
