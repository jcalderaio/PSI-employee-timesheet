...
module.exports = {
  remoteModuleConfig: [
    ...
    ['AlertManager', null, ['alertWithArgs']],
    [
      'ExceptionsManager',
      null,
      [
    ...
    [
      'ScrollViewManager',
      null,
      ['getContentSize', 'calculateChildFrames', 'scrollTo', 'zoomToRect'],
    ],
    null,
    [
    ...
    ['DevLoadingView', null, ['showMessage', 'hide']],
    ['Timing', null, ['createTimer', 'deleteTimer']],
    [
      'AppState',
      null,
      ['getCurrentAppState', 'addListener', 'removeListeners'],
    ],
    ['JSCExecutor', null, ['setContextName']],
    null,
    ['Clipboard', null, ['setString', 'getString'], [1]],
    null,
    null,
    ['KeyboardObserver', null, ['addListener', 'removeListeners']],
    null,
    null,
    [
      'WebViewManager',
      null,
      ['goBack', 'goForward', 'reload', 'stopLoading', 'startLoadWithResult'],
    ],
    null,
    null,
    null,
    ...
    ['NavigatorManager', null, ['requestSchedulingJavaScriptNavigation']],
    [
      'ActionSheetManager',
      null,
      ['showActionSheetWithOptions', 'showShareActionSheetWithOptions'],
    ],
    [
      'LocationObserver',
      null,
    ...
    ['ImageViewManager', null, ['getSize', 'prefetchImage'], [1]],
    null,
    null,
    ['ImageEditingManager', null, ['cropImage']],
    null,
    [
      'LinkingManager',
      null,
    ...
    [
      'NetInfo',
      null,
      ['getCurrentConnectivity', 'addListener', 'removeListeners'],
      [0],
    ],
    [
      'Networking',
      null,
      ['sendRequest', 'abortRequest', 'addListener', 'removeListeners'],
    ],
    null,
    [
      'SettingsManager',
