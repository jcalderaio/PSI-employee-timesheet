	...
	*/
    ...
    var _extends = Object.assign || function(target) {
        ...
        return _inherits(PropState, _React$Component), _createClass(PropState, [ {
            ...
            key: "renderSource",
            value: function() {
                var _props = this.props, id = _props.id, node = _props.node, onViewElementSource = _props.onViewElementSource, source = node.get("source");
                if (!source) return null;
                var onClick, style = styles.source;
